      ...
      return (
        <>
          <Link to="/login" style={{ textDecoration: 'none' }}>
            <div style={{display: 'flex', alignItems: 'center',height: '40px'}}><span className={styles.btn}>LOGIN</span></div></Link>
        ...
        <div className={styles.headerContainer}>
          ...
          <div className={styles.loginSignnUpHeaders}>
            <div className={styles.numberContainer}>
              ...
              <a style={{ textDecoration: 'none' }} href="tel:1-877-355-3585">(877)&nbsp;355-3585</a>
            </div>
          ...
          <div className={styles.navContainer}>
            <a href="/">
            <img src={`${CONSTANTS.STATIC_IMAGES_PATH}blue-logo.png`} className={styles.logo} alt="blue_logo" /></a>
